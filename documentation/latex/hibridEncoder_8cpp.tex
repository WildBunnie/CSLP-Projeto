\hypertarget{hibridEncoder_8cpp}{}\doxysection{src/hibrid-\/encoder/hibrid\+Encoder.cpp File Reference}
\label{hibridEncoder_8cpp}\index{src/hibrid-\/encoder/hibridEncoder.cpp@{src/hibrid-\/encoder/hibridEncoder.cpp}}
...
\item 
int \mbox{\hyperlink{hibridEncoder_8cpp_af48dc56cf008b2f4190393cf00164912}{calculate\+Difference}} (\mbox{\hyperlink{classBlock}{Block}} block1, \mbox{\hyperlink{classBlock}{Block}} block2)
\begin{DoxyCompactList}\small\item\em Calculates the difference between two blocks. \end{DoxyCompactList}\item 
vector$<$ \mbox{\hyperlink{classBlock}{Block}} $>$ \mbox{\hyperlink{hibridEncoder_8cpp_af6ef529e80768812e5eb69f4b7cb2c70}{Divide\+Frame\+Into\+Blocks}} (Mat frame, int block\+Size)
\begin{DoxyCompactList}\small\item\em Divides a frame into blocks. \end{DoxyCompactList}\item 
float \mbox{\hyperlink{hibridEncoder_8cpp_a63a89a6839879b7ad214c64c43281b9a}{distance}} (int x1, int y1, int x2, int y2)
\begin{DoxyCompactList}\small\item\em Calculates the distance between two points. \end{DoxyCompactList}\item 
vector$<$ \mbox{\hyperlink{classBlock}{Block}} $>$ \mbox{\hyperlink{hibridEncoder_8cpp_a237a3b08da266195d4588f4972594dc8}{Blocks\+In\+Search\+Area}} (vector$<$ \mbox{\hyperlink{classBlock}{Block}} $>$ blocks, int search\+\_\+x, int search\+\_\+y, int search\+Area)
\begin{DoxyCompactList}\small\item\em Returns the blocks that are in the search area. \end{DoxyCompactList}\item 
Mat \mbox{\hyperlink{hibridEncoder_8cpp_a09cc283a55256213e35765d60bebb81e}{Perform\+Motion\+Compensation}} (Mat previous\+Frame, vector$<$ \mbox{\hyperlink{classMotionVector}{Motion\+Vector}} $>$ motion\+Vectors, int block\+Size)
\begin{DoxyCompactList}\small\item\em Performs motion compensation. \end{DoxyCompactList}\item 
Mat \mbox{\hyperlink{hibridEncoder_8cpp_af254c922066cc2b05cc7e204210681a1}{Calculate\+Residual}} (Mat current\+Frame, Mat predicted\+Frame)
\begin{DoxyCompactList}\small\item\em Calculates the residual between two frames. \end{DoxyCompactList}\item 
Mat \mbox{\hyperlink{hibridEncoder_8cpp_ad37e62680c71d49f64aa27f4be10e42a}{Decode\+Inter\+Frame}} (Mat previous\+Frame, Mat residuals, int count\+Motion\+Vectors, int block\+Size, \mbox{\hyperlink{classGolomb}{Golomb}} $\ast$gl)
\begin{DoxyCompactList}\small\item\em Inter frame encoder. \end{DoxyCompactList}\item 
void \mbox{\hyperlink{hibridEncoder_8cpp_aa795ad37346875ddfa1a66a5b95113ea}{Encode\+Inter\+Frame}} (Mat current\+Frame, Mat previous\+Frame, int block\+Size, int search\+Area, \mbox{\hyperlink{classGolomb}{Golomb}} $\ast$gl)
\begin{DoxyCompactList}\small\item\em Inter frame decoder. \end{DoxyCompactList}\item 
void \mbox{\hyperlink{hibridEncoder_8cpp_a8b0bd6224b5055ed65d8c1e0c947958a}{Encode\+Hybrid}} (string outputfile, string input\+File, int periodicity, int block\+Size, int Search\+Area)
\begin{DoxyCompactList}\small\item\em Hybrid (inter + intra) encoder. \end{DoxyCompactList}\item 
void \mbox{\hyperlink{hibridEncoder_8cpp_a56338cedf392f0fee37d0f4eb7dacfe3}{Decode\+Hybrid}} (string output\+File, string input\+File)
\begin{DoxyCompactList}\small\item\em Hybrid (inter + intra) frame decoder. \end{DoxyCompactList}\end{DoxyCompactItemize}


\doxysubsection{Function Documentation}
\mbox{\Hypertarget{hibridEncoder_8cpp_a237a3b08da266195d4588f4972594dc8}\label{hibridEncoder_8cpp_a237a3b08da266195d4588f4972594dc8}} 
\index{hibridEncoder.cpp@{hibridEncoder.cpp}!BlocksInSearchArea@{BlocksInSearchArea}}
\index{BlocksInSearchArea@{BlocksInSearchArea}!hibridEncoder.cpp@{hibridEncoder.cpp}}
...
\begin{center}
\leavevmode
\includegraphics[width=287pt]{hibridEncoder_8cpp_a237a3b08da266195d4588f4972594dc8_cgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{hibridEncoder_8cpp_a237a3b08da266195d4588f4972594dc8_icgraph}
\end{center}
\end{figure}
\mbox{\Hypertarget{hibridEncoder_8cpp_af48dc56cf008b2f4190393cf00164912}\label{hibridEncoder_8cpp_af48dc56cf008b2f4190393cf00164912}} 
\index{hibridEncoder.cpp@{hibridEncoder.cpp}!calculateDifference@{calculateDifference}}
\index{calculateDifference@{calculateDifference}!hibridEncoder.cpp@{hibridEncoder.cpp}}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{hibridEncoder_8cpp_af48dc56cf008b2f4190393cf00164912_icgraph}
\end{center}
\end{figure}
\mbox{\Hypertarget{hibridEncoder_8cpp_af254c922066cc2b05cc7e204210681a1}\label{hibridEncoder_8cpp_af254c922066cc2b05cc7e204210681a1}} 
\index{hibridEncoder.cpp@{hibridEncoder.cpp}!CalculateResidual@{CalculateResidual}}
\index{CalculateResidual@{CalculateResidual}!hibridEncoder.cpp@{hibridEncoder.cpp}}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{hibridEncoder_8cpp_af254c922066cc2b05cc7e204210681a1_icgraph}
\end{center}
\end{figure}
\mbox{\Hypertarget{hibridEncoder_8cpp_a56338cedf392f0fee37d0f4eb7dacfe3}\label{hibridEncoder_8cpp_a56338cedf392f0fee37d0f4eb7dacfe3}} 
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{hibridEncoder_8cpp_a56338cedf392f0fee37d0f4eb7dacfe3_cgraph}
\end{center}
\end{figure}
Here is the caller graph for this function\+:
\nopagebreak
...
\begin{center}
\leavevmode
\includegraphics[width=243pt]{hibridEncoder_8cpp_a56338cedf392f0fee37d0f4eb7dacfe3_icgraph}
\end{center}
\end{figure}
\mbox{\Hypertarget{hibridEncoder_8cpp_ad37e62680c71d49f64aa27f4be10e42a}\label{hibridEncoder_8cpp_ad37e62680c71d49f64aa27f4be10e42a}} 
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{hibridEncoder_8cpp_ad37e62680c71d49f64aa27f4be10e42a_cgraph}
\end{center}
\end{figure}
Here is the caller graph for this function\+:
\nopagebreak
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{hibridEncoder_8cpp_ad37e62680c71d49f64aa27f4be10e42a_icgraph}
\end{center}
\end{figure}
\mbox{\Hypertarget{hibridEncoder_8cpp_a63a89a6839879b7ad214c64c43281b9a}\label{hibridEncoder_8cpp_a63a89a6839879b7ad214c64c43281b9a}} 
\index{hibridEncoder.cpp@{hibridEncoder.cpp}!distance@{distance}}
\index{distance@{distance}!hibridEncoder.cpp@{hibridEncoder.cpp}}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{hibridEncoder_8cpp_a63a89a6839879b7ad214c64c43281b9a_icgraph}
\end{center}
\end{figure}
\mbox{\Hypertarget{hibridEncoder_8cpp_af6ef529e80768812e5eb69f4b7cb2c70}\label{hibridEncoder_8cpp_af6ef529e80768812e5eb69f4b7cb2c70}} 
\index{hibridEncoder.cpp@{hibridEncoder.cpp}!DivideFrameIntoBlocks@{DivideFrameIntoBlocks}}
\index{DivideFrameIntoBlocks@{DivideFrameIntoBlocks}!hibridEncoder.cpp@{hibridEncoder.cpp}}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{hibridEncoder_8cpp_af6ef529e80768812e5eb69f4b7cb2c70_icgraph}
\end{center}
\end{figure}
\mbox{\Hypertarget{hibridEncoder_8cpp_a8b0bd6224b5055ed65d8c1e0c947958a}\label{hibridEncoder_8cpp_a8b0bd6224b5055ed65d8c1e0c947958a}} 
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{hibridEncoder_8cpp_a8b0bd6224b5055ed65d8c1e0c947958a_cgraph}
\end{center}
\end{figure}
Here is the caller graph for this function\+:
\nopagebreak
...
\begin{center}
\leavevmode
\includegraphics[width=241pt]{hibridEncoder_8cpp_a8b0bd6224b5055ed65d8c1e0c947958a_icgraph}
\end{center}
\end{figure}
\mbox{\Hypertarget{hibridEncoder_8cpp_aa795ad37346875ddfa1a66a5b95113ea}\label{hibridEncoder_8cpp_aa795ad37346875ddfa1a66a5b95113ea}} 
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{hibridEncoder_8cpp_aa795ad37346875ddfa1a66a5b95113ea_cgraph}
\end{center}
\end{figure}
Here is the caller graph for this function\+:
\nopagebreak
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{hibridEncoder_8cpp_aa795ad37346875ddfa1a66a5b95113ea_icgraph}
\end{center}
\end{figure}
\mbox{\Hypertarget{hibridEncoder_8cpp_a09cc283a55256213e35765d60bebb81e}\label{hibridEncoder_8cpp_a09cc283a55256213e35765d60bebb81e}} 
\index{hibridEncoder.cpp@{hibridEncoder.cpp}!PerformMotionCompensation@{PerformMotionCompensation}}
\index{PerformMotionCompensation@{PerformMotionCompensation}!hibridEncoder.cpp@{hibridEncoder.cpp}}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{hibridEncoder_8cpp_a09cc283a55256213e35765d60bebb81e_icgraph}
\end{center}
\end{figure}
